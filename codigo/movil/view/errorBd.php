...
<html>
    ...
    <body>
        <div align="center" style="margin-top: 100px;">            
            <img style="width: 30px; height: 30px;" src="../../images/warning.png" />
            
            <h2 style="max-width: 380px" ><?php echo _("Se ha producido un error en la base de datos por favor intentelo de nuevo más tarde") ?></h2>
