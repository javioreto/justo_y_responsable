...
<html>
    ...
    <body>
        ...
        ?>
            <div align='center' id='result' data-role='header'>
                <p><?php echo _("Establecimientos en mi ubicación") ?></p>
                <div id="divpanellegen" >
                    <a data-ajax='false' href='#legenPanel' class="ui-btn ui-corner-all ui-shadow ui-icon-info ui-btn-right ui-btn-icon-notext"></a>
                </div>
            </div>        
            ...
            <div id="list-search">
                ...
                <ul data-role="listview" data-inset="true" class="pagination">
                    <?php
                        ...
                        if($mlatitude==0 && $mlongitude==0){
                            $establishment = Search::searchEstablishmentByArrayId($arrE);
                            if(count($establishment)>0){
                                ...
                                foreach($establishment AS $est){
                                    ...
                                    ?>
                                        <li>
                                            <?php if($est->getSector()->getName()=="Comercio justo"){ ?>
                                                <a style='background-color: #B5D6E6' data-ajax='false' href='information.php?idEstablecimiento="<?php echo $est->getIdEstablishment() ?>"'>
                                            <?php }
                                            if($est->getSector()->getName()=="Banca etica"){ ?>
                                                <a style='background-color: #E6CCE4' data-ajax='false' href='information.php?idEstablecimiento="<?php echo $est->getIdEstablishment() ?>"'> 
                                            <?php }
                                            if($est->getSector()->getName()=="Economia solidaria"){ ?>
                                                <a style='background-color: #B5E6BF' data-ajax='false' href='information.php?idEstablecimiento="<?php echo $est->getIdEstablishment() ?>"'>
                                            <?php }
                                            if($est->getSector()->getName()=="Consumidores y usuarios organizados"){ ?>
                                                <a style='background-color: #FAE69A' data-ajax='false' href='information.php?idEstablecimiento="<?php echo $est->getIdEstablishment() ?>"'>
                                            <?php }  ?> 
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td id='content'>
                                                            <h1><?php echo $est->getName() ?></h1>
                                                            <p><?php echo $est->getAddress() ?>,<?php echo $est->getLocation() ?></p>
                            ...
                            $cant = 1;
                            Search::searchEstablishmentNearByArrayId($mlatitude, $mlongitude, $arrE);
                        }  
                    ?>
                </ul>
            <?php
