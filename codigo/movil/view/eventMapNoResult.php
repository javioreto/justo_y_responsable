...
<html>
    ...
    <body>
        <div style="margin-left: 10px; margin-right: 10px;">
            ...
            <p><?php echo _("No se ha encontrado ningún evento que cumpla los criterios indicados para la búsqueda. Puede realizar una nueva búsqueda, modificando los distintos valores") ?></p>
        </div>
