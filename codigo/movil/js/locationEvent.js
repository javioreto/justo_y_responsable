...
function errorPosicionar(error) {
    ...
    {  
        ...
        case error.POSITION_UNAVAILABLE:  
            var page = '../view/startEvents.php?lat=0&long=0';
...
/***********************************************
    Esta funciÃ³n se ejecuta si la llamada a  navigator.geolocation.getCurrentPosition
    tiene Ã©xito. La latitud y la longitud vienen dentro del objeto coords. 
***********************************************/
 
function centrarMapa(pos){
    var page = '../view/startEvents.php?lat='+pos.coords.latitude+'&long='+pos.coords.longitude+'';
	setTimeout(document.location.href=page,12500);
}
