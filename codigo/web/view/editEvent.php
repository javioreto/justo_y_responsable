...
$event = Load::loadEventById($idEvent);
...
<html>
    ...
    <body>
        ...
        <form id="addEstablishment" onsubmit="return valida()" action="../controller/updateEvent.php" method="POST">
            ...
            <div class="form-group col-md-offset-8 col-md-2">
                <div style="margin-top: -10px; margin-bottom: 10px;" id="btndarsedealta">
                    <button id="btnalta" class="btn btn-default" type="button" onclick="eliminar();"><?php echo _("Eliminar evento")  ?></button>
                    <button id="btnalta" class="btn btn-default" type="submit" ><?php echo _("Guardar cambios")  ?></button>
                </div>
            </div>  
        ...
        <div class="col-md-12">
            ...
            <div class="form-horizontal col-md-offset-2 col-md-4" role="form">
                <input type="hidden" id="selectUsers" name="selectUsers"  value="<?php echo $event->getidEstablecimiento() ?>">
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">         
                        ...
                        <div class="col-md-offset-1 col-md-9">
                          ...
                          <input type="hidden" id="adr" name="adr" value="<?php echo $event->getdireccion() ?>" />
                          <input type="hidden" id="lat" name="miLat" value="<?php echo $event->getlatitud() ?>" />
                          <input type="hidden" id="lng" name="miLng" value="<?php echo $event->getlongitud() ?>" />
                          <input type="hidden" id="cp" name="cp" value="<?php echo $event->getcp() ?>" />
                          <input type="hidden" id="locality" name="locality" value="<?php echo $event->getlocalidad() ?>" />
                          <input  type="text" class="form-control" id="address" name="address" autocomplete="on" runat="server" placeholder="<?php echo _("Dirección:") ?>" value="<?php echo $event->getdireccion()." - ".$event->getlocalidad()  ?>">
                        </div>
                      </div>
            ...
            <div class="form-horizontal col-md-4 " role="form">
                <div class="form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control" style="height:150px;"><?php echo $event->getdescripcion() ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="fecha" class="col-md-3 control-label"><?php echo _("*Fecha:") ?></label>
                    <div class="col-md-offset-1 col-md-8">
                        <input class="form-control" type="date" name="fecha" id="fecha" value="<?php echo $event->getfecha() ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="schedule" class="col-md-3 control-label"><?php echo _("*Horario:") ?></label>
                    <div class="col-md-offset-1 col-md-3">
                      <label class="control-label">Comienzo: </label><input type="text" class="form-control" id="inicio" name="inicio" placeholder="00:00" value="<?php echo $event->getinicio() ?>">
                      <label class="control-label">Fin: </label><input type="text" class="form-control" id="fin" name="fin" placeholder="23:00" value="<?php echo $event->getfin() ?>">
                    </div>
                </div>
                    ...
                    <div class="col-md-offset-1 col-md-11">
                        <label><?php echo _("*Tipo") ?></label>
                         <select id="tipo" name="tipo" class="form-control">
                          <option value="<?php echo $event->getidTipo() ?>"><?php echo Load::eventType($event->getidTipo()) ?></option>
        ...
        <script>
            ...
            var markers = 0;
            var lat =  <?php echo $event->getlatitud() ?>;
            var lng = <?php echo $event->getlongitud() ?>;
            var map = new GMaps({
